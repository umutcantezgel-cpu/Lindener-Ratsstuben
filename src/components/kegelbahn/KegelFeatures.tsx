            ...
            <div className="container mx-auto px-4 max-w-5xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
                    {features.map((feature, idx) => (
                        ...
                        >
                            {/* Number Accent */}
                            <span className="text-8xl font-display font-light text-text-tertiary/40 mb-8 select-none transition-colors duration-700 group-hover:text-muted-gold/20" aria-hidden="true">
                                {feature.number}
                            </span>
                            
                            <h2 className="text-3xl font-display text-text-primary mb-6 uppercase tracking-wider relative">
                                {feature.title}
