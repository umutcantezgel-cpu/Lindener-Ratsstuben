        ...
        >
            ...
            <div className="md:hidden w-full flex justify-center z-40">
                <button 
                    ...
                    className="flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 text-white px-6 py-2 rounded-full text-xs uppercase tracking-[0.2em] shadow-lg shadow-black/20 hover:bg-white/20 transition-colors"
                >
            ...
            >
                    ...
                    <div className="flex items-center gap-5 justify-between rtl:flex-row-reverse mb-4 relative z-10 w-full">
                        <div className="flex -space-x-3 rtl:space-x-reverse shrink-0">
                            {[20, 31, 42].map((imgId, i) => (
                                <div key={i} className="w-10 h-10 xl:w-12 xl:h-12 rounded-full border-[3px] border-white/20 xl:border-onyx-dark overflow-hidden bg-gray-800 relative shadow-md group-hover:scale-105 transition-transform duration-500" style={{ transitionDelay: `${i * 75}ms` }}>
                        ...
                        <div className="flex-1 text-right rtl:text-left">
                            ...
                            <p className="text-white xl:text-onyx-dark text-[10px] xl:text-xs font-bold mt-[6px] tracking-widest rtl:tracking-normal uppercase">{t('hero.glasspane.rating_stars') as string}</p>
                        </div>
                    </div>
                ...
                <div className="md:snap-center shrink-0 w-full md:w-[340px] xl:w-full self-center xl:self-start xl:-mt-12 xl:ms-8 bg-white/10 xl:bg-white/70 backdrop-blur-[24px] border border-white/20 xl:border-stone-200/50 shadow-lg p-6 xl:p-7 rounded-[2rem] max-w-[340px] hover:bg-white/20 xl:hover:bg-white/90 xl:hover:border-stone-200 transition-all duration-700 relative overflow-hidden cursor-default group transform-gpu z-10">
                    ...
                    <div className="flex items-start gap-4 xl:gap-5 relative z-10 rtl:flex-row-reverse">
                        <div className="w-10 h-10 xl:w-12 xl:h-12 rounded-full bg-white/10 xl:bg-white border border-white/20 xl:border-stone-100 text-muted-gold flex items-center justify-center shrink-0 shadow-sm group-hover:bg-white/20 xl:group-hover:bg-stone-50 transition-colors duration-700">
                        ...
                        <div className="w-full pt-1">
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center text-xs xl:text-sm border-b border-white/10 xl:border-stone-200 pb-2 rtl:flex-row-reverse">
                                    <span className="text-gray-300 xl:text-gray-500 font-light flex-none w-1/3">{t('hero.glasspane.hours_lunch') as string}</span>
                                    <span className="text-white xl:text-onyx-dark font-mono font-medium tracking-wide rtl:tracking-normal text-right">{formatTime(companyData.openingHours.regulaer.mittags)}</span>
                                </div>
                                <div className="flex justify-between items-center text-xs xl:text-sm pt-1 rtl:flex-row-reverse">
                                    ...
                                    <span className="text-white xl:text-onyx-dark font-mono font-medium tracking-wide rtl:tracking-normal text-right">{formatTime(companyData.openingHours.regulaer.abends)}</span>
                                </div>
                            </div>
                        </div>
                    </div>
