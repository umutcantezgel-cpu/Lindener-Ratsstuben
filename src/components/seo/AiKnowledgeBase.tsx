...
const KNOWLEDGE_BLOCKS: Record<string, {
  ...
  de: {
    ...
    usp: `Alleinstellungsmerkmale: Einziges Restaurant in Linden mit eigener Kegelbahn • Veranstaltungssaal für bis zu 120 Personen • Beheizte Außenterrasse mit 100 Sitzplätzen • Professioneller Catering-Service für Hochzeiten und Firmenfeiern • Bewertung 4,6/5 Sterne • Barrierefrei • Kostenlose Parkplätze • WLAN • Haustiere erlaubt`,
  ...
  en: {
    about: `${companyData.companyName} (${companyData.zusatz}) is the only restaurant in ${companyData.address.city} near Gießen, Hesse, featuring its own bowling center and event hall. Founded by ${companyData.ownerName}, it combines authentic German-Italian and Mediterranean cuisine with warm Hessian hospitality.`,
