    ...
    <PrintPage pageNum={pageNum}>
      <div style={{ maxWidth: '90%', margin: '0 auto', paddingTop: '40px', position: 'relative' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          <DishItem id="W1" name="PINOT GRIGIO DOC (Veneto)" price="5,50 €" descStyle={{ fontSize: '14px', lineHeight: '1.5' }} desc="Trocken, feinfruchtig, mit einer eleganten Apfelnoten. Perfekt zu Salaten und Geflügel. (0,2l)" marginBottom="20px" />
          <DishItem id="W2" name="CHARDONNAY IGT (Puglia)" price="6,00 €" descStyle={{ fontSize: '14px', lineHeight: '1.5' }} desc="Florales Bouquet, vollmundig und harmonisch. Ideal zu hellen Soßen und Edelfisch. (0,2l)" marginBottom="20px" />
        ...
        <div style={{ marginBottom: '30px' }}>
          <DishItem id="W4" name="MONTEPULCIANO D'ABRUZZO DOC" price="5,50 €" descStyle={{ fontSize: '14px', lineHeight: '1.5' }} desc="Trocken, rubinrot, milde Tannine mit intensiven Noten von roter Kirsche. (0,2l)" marginBottom="20px" />
          <DishItem id="W5" name="PRIMITIVO DI MANDURIA DOC" price="7,00 €" descStyle={{ fontSize: '14px', lineHeight: '1.5' }} desc="Samtig, üppig und warmkirschig. Ein kräftiger Begleiter zu gegrilltem Fleisch und Pasta al Forno. (0,2l)" marginBottom="20px" />
        ...
        <div style={{ textAlign: 'center' }}>
          <Quote text="Il vino è poesia imbottigliata" marginTop="30px" />
        </div>
