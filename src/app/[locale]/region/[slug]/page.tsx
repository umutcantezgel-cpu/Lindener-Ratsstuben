...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const article = getRegionalArticle('region', params.slug);
  ...
  return {
    ...
    alternates: {
      canonical: `https://lindener-ratsstuben.de/${params.locale}/region/${params.slug}`
    }
  };
}

export async function generateStaticParams() {
  const slugs = getRegionalSlugsByCategory('region');
