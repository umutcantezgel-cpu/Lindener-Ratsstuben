...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        alternates: getAlternates('de', 'impressum'),
...
export default async function ImpressumPage({ params }: { params: Promise<{ locale: string }> }) {
    ...
    return (
        <LegalPageLayout title={title} lastUpdated="April 2026" locale={locale} pageKey="impressum">
            ...
            <p>
                Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit, die Sie unter folgendem Link finden: <a href="https://consumer-redress.ec.europa.eu/site-relocation_en" target="_blank" rel="noopener noreferrer">Online-Streitbeilegungsplattform der EU</a>.<br />
