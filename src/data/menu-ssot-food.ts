...
export const foodItems: SSOTMenuItem[] = [
  ...
  // §3.2 Vorspeisen
  { nr: '20', name: 'Klassische Bruschetta', description: 'Geröstete Weißbrotscheiben mit frischen Tomaten, Zwiebeln, Oliven und Knoblauch, veredelt mit extra nativem Olivenöl. Wahlweise mit überbackenem Mozzarella (+2,00 €).', price: 7.90, category: 'vorspeisen', allergens: ['A'] },
  { nr: '21', name: 'Parmaschinken mit Melone', description: 'Edler luftgetrockneter Parmaschinken, serviert mit sonnengereifter Melone.', price: 12.90, category: 'vorspeisen', allergens: ['O'] },
  { nr: '22', name: 'Burrata', description: 'Cremige Burrata auf feinem Tomaten-Carpaccio, verfeinert mit einer Balsamico-Kräutervinaigrette und Basilikum-Pesto.', price: 13.90, category: 'vorspeisen', allergens: ['G', 'H', 'O'] },
  { nr: '23', name: 'Kalbfleisch mit Thunfischsauce', description: 'Zart rosa gegartes Kalbfleisch, fein aufgeschnitten, begleitet von einer cremigen Thunfischsauce mit Kapern, Sardellen & Ei.', price: 14.90, category: 'vorspeisen', allergens: ['C', 'D', 'G', 'L', 'O'] },
  ...
  { nr: '25', name: 'Gemischte Vorspeisen nach Art des Hauses', description: 'Eine erlesene Auswahl italienischer Vorspeisenspezialitäten nach Art des Hauses – warm und kalt serviert. Auch als stilvolle Antipasti-Platten für mehrere Personen erhältlich. Pro Person 13,90 €.', price: 16.90, category: 'vorspeisen', allergens: ['A', 'C', 'D', 'G', 'O'] },
  // §3.3 Salate
  ...
  { nr: '33', name: 'Meeresfrüchtesalat', description: 'Rucolasalat mit köstlich marinierten Meeresfrüchten, Cocktailtomaten und roten Zwiebeln in Balsamico-Kräuter-Vinaigrette.', price: 15.90, category: 'salate', allergens: ['B', 'M', 'O', 'R'] },
  ...
  { nr: '36', name: 'Chef Salat', description: 'Bunter Salatteller mit argentinischem Rinderfleisch und gehobeltem Grana Padano, serviert mit hausgemachtem Joghurtdressing.', price: 18.90, category: 'salate', allergens: ['C', 'G', 'M', 'O'] },
  // §3.4 Pasta
  ...
  { nr: '42', name: 'Rigatoni nach Apulien-Art', description: 'Mit knusprigem Guanciale (Schweinebacke), Brokkoli, Zwiebeln und einem Hauch Knoblauch in aromatischer Tomatensauce, verfeinert mit geriebenem Parmigiano.', price: 16.90, category: 'pasta', allergens: ['A', 'G'] },
  { nr: '43', name: 'Rigatoni „Ratsstube"', description: 'Mit gebratener Hähnchenbrust und frischen Champignons in cremiger Tomaten-Sahnesauce, serviert mit Parmigiano.', price: 16.90, category: 'pasta', allergens: ['A', 'G'] },
  { nr: '44', name: 'Bandnudeln mit Gemüse-Ragout', description: 'Feine Bandnudeln mit frischem Marktgemüse-Ragout in aromatischer Tomatensauce, dazu geriebener Parmigiano.', price: 14.90, category: 'pasta', allergens: ['A', 'G', 'L'] },
  ...
  { nr: '48', name: 'Nudel-Kombination', description: 'Drei verschiedene Pasta in geschmortes Rinderhackfleisch in aromatische Tomaten Soße überbacken mit Mozzarella.', price: 13.90, category: 'pasta-al-forno', allergens: ['A', 'G', 'L'] },
  { nr: '49', name: 'Rigatoni mit Gemüse-Ragout', description: 'Mit frischem Marktgemüse Ragout in Cremigen Sahne Soße überbacken mit Mozzarella.', price: 13.90, category: 'pasta-al-forno', allergens: ['A', 'G', 'L'] },
  { nr: '62', name: 'Tortellini mit Schinken und Sahne', description: 'Tortellini gefüllt mit Fleisch in Vorderschinken Sahne Soße überbacken mit Mozzarella.', price: 16.90, category: 'pasta-al-forno', allergens: ['A', 'C', 'G'] },
  // §3.6 Hausgemachte Pasta
  { nr: '50', name: 'Tortellini in Sahnesauce', description: 'Mit Vorderschinken, Ei in Cremigen Sahne Soße serviert geriebenen Parmigiano.', price: 14.90, category: 'hausgemachte-pasta', allergens: ['A', 'C', 'G'] },
  ...
  { nr: '53', name: 'Gnocchi mit Garnelen', description: 'Gefüllte Kartoffel-Gnocchi mit Tomaten und Mozzarella, gebratenen Garnelen in cremiger Tomaten-Sahnesauce.', price: 17.90, category: 'hausgemachte-pasta', allergens: ['A', 'B', 'G'] },
  { nr: '54', name: 'Gnocchi mit Basilikumpesto und Burrata', description: 'Gefüllte Kartoffel-Gnocchi mit cremiger Burrata und Basilikum-Pesto.', price: 15.90, category: 'hausgemachte-pasta', allergens: ['A', 'G', 'H'] },
  ...
  { nr: '71', name: 'Rahm-Schnitzel', description: 'In Cremigen Rahm Soße. Dazu servieren wir Pommes Frites & Salat der Saison.', price: 17.90, category: 'schnitzel', allergens: ['A', 'C', 'G'] },
  { nr: '72', name: 'Jäger-Schnitzel', description: 'Mit frischen Champignons in Brauner Soße. Dazu servieren wir Pommes Frites & Salat der Saison.', price: 18.90, category: 'schnitzel', allergens: ['A', 'C', 'L'] },
  { nr: '73', name: 'Pfeffer-Schnitzel', description: 'Mit Grünen Madagaskar-Pfefferkörnern in cremige Rahmsoße. Dazu servieren wir Pommes Frites & Salat der Saison.', price: 18.90, category: 'schnitzel', allergens: ['A', 'C', 'G'] },
  { nr: '74', name: 'Bauern-Schnitzel', description: 'Mit knusprig gebratenem Speck & Zwiebeln. Dazu servieren wir Pommes Frites & Salat der Saison.', price: 19.90, category: 'schnitzel', allergens: ['A', 'C'] },
  { nr: '75', name: 'Schlemmer-Schnitzel', description: 'Mit frischem Champignon in Cremige Bernaise Soße. Dazu servieren wir Pommes Frites & Salat der Saison.', price: 19.90, category: 'schnitzel', allergens: ['A', 'C', 'G', 'M'] },
  { nr: '76', name: 'Lindener Rucksack', description: 'Gefüllt mit Vorder-Schinken & Mozzarella Käse in frischem Champignon Sahne Soße.', price: 21.90, category: 'schnitzel', allergens: ['A', 'C', 'G'] },
  // §3.8 Fleischgerichte & Fischgerichte
  { nr: '80', name: 'Gegrilltes Hähnchenbrustfilet', description: 'Hähnchenbrustfilet vom Grill mit hausgemachter Kräuter-Butter & Zitronen Scheibe. Dazu servieren wir frisches Marktgemüse & Gourmet Kartoffeln.', price: 19.90, category: 'fleisch-fisch', allergens: ['G'] },
  ...
  { nr: '82', name: 'Schweinefilet in Weißwein-Zitronensauce', description: 'Schweinefilet Medaillons vom Grill in Weißwein, Zitronen Kräuter Knoblauch Soße. Dazu servieren wir frisches Marktgemüse & Gourmet Kartoffeln.', price: 23.90, category: 'fleisch-fisch', allergens: ['G', 'O'] },
  { nr: '83', name: 'Schweinefilet in grüner Pfeffersauce', description: 'Schweinefilet vom Grill mit grünen Madagaskar Pfefferkörner in cremigen Rahm Soße. Dazu servieren wir frisches Marktgemüse & Gourmet Kartoffeln.', price: 24.90, category: 'fleisch-fisch', allergens: ['G'] },
  ...
  { nr: '88', name: 'Gegrillter Tintenfisch', description: 'Marinierten Tintenfisch nach Art des Hauses. Dazu servieren wir frisches Marktgemüse & Gourmet Kartoffeln.', price: 25.90, category: 'fleisch-fisch', allergens: ['R'] },
  ...
  { nr: '98', name: 'Pizza Amore Mio', description: 'Mozzarella-Käse, frische Champignons, Kirsch-Tomaten & Basilikum.', price: 14.50, category: 'pizza', allergens: ['A', 'G'] },
  { nr: '99', name: 'Pizza Thunfisch', description: 'Saftigem Thunfisch, frische Champignons, Rote-Zwiebeln.', price: 14.50, category: 'pizza', allergens: ['A', 'D', 'G'] },
  ...
  { nr: '102', name: 'Pizza Lachs und Garnelen', description: 'Lachsfilet aus Norwegen, Garnelen, Kirsch-Tomaten & Knoblauch.', price: 17.50, category: 'pizza', allergens: ['A', 'B', 'D', 'G'] },
  { nr: '103', name: 'Pizza Deluxe', description: 'Hauch dünn geschnittene Kalbsfleisch, Cremige Thunfisch Soße, mariniertem Rucola Salat gehobeltem Grana Padano.', price: 15.50, category: 'pizza', allergens: ['A', 'C', 'D', 'G'] },
  // Nr. 104 fehlt in der Quelle — NICHT auffüllen (SSOT §4.1)
  { nr: '105', name: 'Pizza Vegetarisch', description: 'Gegrilltem frisches Marktgemüse.', price: 14.50, category: 'pizza', allergens: ['A', 'G'] },
  ...
  { nr: '113', name: 'Pizza Thunfisch', description: 'Saftiger Thunfisch, rote Zwiebeln und frische Champignons.', price: 43.00, category: 'familienpizza', allergens: ['A', 'D', 'G'] },
  ...
  { nr: '134', name: 'Bourbon-Vanilleeis (je Kugel)', description: 'Feines Bourbon-Vanilleeis mit intensivem Vanillearoma.', price: 3.00, category: 'dessert', allergens: ['G'] },
];
