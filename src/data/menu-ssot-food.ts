...
export const foodItems: SSOTMenuItem[] = [
  ...
  { nr: '67', name: 'Lindener Rucksack', description: 'Gefüllt mit Vorderschinken und Mozzarella in frischer Champignon-Sahnesauce. Dazu servieren wir Pommes frites und einen Salat der Saison.', price: 22.90, category: 'schnitzel', allergens: ['A','B','E1','G','I','P'], zusatzstoffe: ['1','2','3','5'] },
